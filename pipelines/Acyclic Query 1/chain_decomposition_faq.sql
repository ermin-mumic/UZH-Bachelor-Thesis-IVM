...
SELECT movie_id, COUNT(*) AS COUNT_C1
FROM CHILD_1_Q
GROUP BY movie_id;
...
SELECT company_type_id, COUNT(*) AS COUNT_C2
FROM CHILD_2_Q
...
SELECT movie_id, SUM(COUNT_C1 * COUNT_C2) AS COUNT_C3
FROM CHILD_3_Q
GROUP BY movie_id;
...
SELECT info_type_id, SUM(COUNT_C3) AS COUNT_C4
FROM CHILD_4_Q
