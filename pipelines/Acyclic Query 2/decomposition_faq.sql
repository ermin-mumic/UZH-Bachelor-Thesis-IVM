...
SELECT company_id, COUNT(*) AS COUNT_C1
FROM CHILD_1_Q
GROUP BY company_id;
...
SELECT info_type_id, COUNT(*) AS COUNT_C2
FROM CHILD_2_Q
...
SELECT movie_id, SUM(COUNT_C1) AS COUNT_C3
FROM CHILD_3_Q
GROUP BY movie_id;
...
SELECT movie_id, SUM(COUNT_C2) AS COUNT_C4
FROM CHILD_4_Q
GROUP BY movie_id;
...
SELECT person_id, COUNT(*) AS COUNT_C5
FROM CHILD_5_Q
GROUP BY person_id;
...
SELECT role_id, COUNT(*) AS COUNT_C6
FROM CHILD_6_Q
GROUP BY role_id;
...
SELECT person_id, COUNT(*) AS COUNT_C7
FROM CHILD_7_Q
GROUP BY person_id;
...
SELECT char_id, COUNT(*) AS COUNT_C8
FROM CHILD_8_Q
GROUP BY char_id;
...
SELECT movie_id, COUNT(*) AS COUNT_C9
FROM CHILD_9_Q
GROUP BY movie_id;
...
SELECT SUM(COUNT_C5 * COUNT_C6 * COUNT_C7 * COUNT_C3 * COUNT_C8 * COUNT_C4 * COUNT_C9) AS total_count
FROM ROOT_Q;