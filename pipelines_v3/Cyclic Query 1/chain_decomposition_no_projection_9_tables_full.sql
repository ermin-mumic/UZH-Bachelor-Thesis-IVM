...
SELECT ROOT_Q.A AS A, CHILD_2_Q.B AS B, CHILD_1_Q.C AS C, CHILD_2_Q.D AS D, ROOT_Q.E AS E, ROOT_Q.F AS F
FROM ROOT_Q
JOIN CHILD_3_Q ON ROOT_Q.A = CHILD_3_Q.A AND ROOT_Q.E = CHILD_3_Q.E
JOIN CHILD_2_Q ON CHILD_3_Q.A = CHILD_2_Q.A AND (ROOT_Q.A = CHILD_2_Q.A) AND CHILD_3_Q.D = CHILD_2_Q.D
JOIN CHILD_1_Q ON CHILD_2_Q.B = CHILD_1_Q.B AND CHILD_2_Q.D = CHILD_1_Q.D AND (CHILD_3_Q.D = CHILD_1_Q.D);
