...
SELECT CHILD_1_Q.A AS A, CHILD_1_Q.B AS B, CHILD_2_Q.C AS C, CHILD_2_Q.D AS D, CHILD_2_Q.E AS E
FROM ROOT_Q
JOIN CHILD_1_Q ON ROOT_Q.B = CHILD_1_Q.B AND ROOT_Q.E = CHILD_1_Q.E
JOIN CHILD_2_Q ON ROOT_Q.C = CHILD_2_Q.C AND ROOT_Q.E = CHILD_2_Q.E AND (CHILD_2_Q.E = CHILD_1_Q.E);
