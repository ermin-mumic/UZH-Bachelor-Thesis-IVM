...
\begin{longtable}{lrrrrr}
    ...
    \bottomrule
    \multicolumn{6}{l}{\small $D_1$/$D_2$: less / more balanced root orientation. Prime ($D'$): without semijoins.} \\
    \multicolumn{6}{l}{\small Note: all graph decompositions are without semijoins (prime). \texttt{TO} indicates experimental timeout.} \\
    \endfoot  
    ...
    \quad $D_2'$           &  970'903'178r         & 77.64min             &  --                  &                   & 43.7GiB   \\
...
\begin{longtable}{lrrrrr}
    ...
    $D_2'^{\text{full}}$   &  0r                   &  0.10min            &  216'602r/s          &                   & 1.1GiB    \\
    \midrule
...
\begin{longtable}{lrrrrr}
    ...
    \bottomrule
    \multicolumn{6}{l}{\small $D_1$: Decomposition with projections (semijoins). No-projection variants are denoted with a prime symbol ($D_1'$).} \\
    \endfoot  
...
\begin{longtable}{lrrrrr}
    ...
    \bottomrule
    \multicolumn{6}{l}{\small $D_1$/$D_2$: less / more balanced root orientation. Prime ($D'$): without semijoins.} \\
    \multicolumn{6}{l}{\small Note: No projection variants are denoted with prime symbol.  \texttt{TO} indicates experimental timeout.} \\
    \endfoot  
